    ...
    const { choice } = await prompt([
        {
            type: "list",
            name: "choice",
            message: "Welcome to the menu. What would you like to do?",
            choices: [
                {
...
async function removeEmployee() {
    ...
    console.log("Successfully removed employee from the database");
    ...
    const { managerId } = await prompt([
        {
            type: "list",
            name: "managerId",
            message: "Which employee do you want to set as manager for the employee selected?",
            choices: managerChoices
        }
    ]);
...
async function addEmployee() {
    ...
    console.log(
        `Added ${employee.first_name} ${employee.lastname} to the database`
    );
